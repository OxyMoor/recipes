        ...
        dishesList: 
            [
                ...
                },
                {
                    ...
                    ingredientsList: [{ingr: 'вареники', quant: '1 упаковка'}],
            ...
            [
                {
                    imgSrc: './img/dishes/breakfast/test-dish.jpg',
                    title: 'Сырники',
                    ingredientsList: [{ingr: 'творог 5%', quant: '400г'}, {ingr: 'желток', quant: '2шт'}, {ingr: 'мука', quant: '2-3ст.л.'}, {ingr: 'сахар', quant: 'по вкусу'}],
                    note: 'Тесто скатать в колбаску, обвалять в муке, разделить на сырники, каждый обвалять в муке. Жарить с обеих сторон.'
                },
                {
                    imgSrc: './img/dishes/breakfast/test-dish.jpg',
